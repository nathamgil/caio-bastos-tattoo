/* =====================================================================
   Caio Bastos Tattoo — configuração
...
window.TV = {
  ...
  /* ---- Artista ------------------------------------------------------ */
  nome:       'Caio Bastos Tattoo',
  slogan:     'A vida é irada!',
  instagram:  'caiobastostattoo',
  tiktok:     'caiobastostattoo',
  email:      'caiobastostattoo@gmail.com',

  // WhatsApp de "Orçamentos e Dúvidas" do Linktree (conferido em 23/09/2026).
  whatsapp:        '5571992932165',
  whatsappVisivel: '(71) 99293-2165',

  // Endereço exato A CONFIRMAR. A bio só diz "Barra, Salvador".
  endereco: {
    linha1: 'Barra',
    linha2: 'Salvador — BA',
    maps:   'https://www.google.com/maps/search/?api=1&query=Barra+Salvador+BA',
    busca:  'Barra, Salvador - BA'
  },

  // Países onde também atende (bio do Instagram). Datas A CONFIRMAR.
  viagens: ['Espanha', 'Argentina', 'Paraguai', 'Portugal', 'Itália', 'Reino Unido'],
  ...
  /* ---- Expediente (0 = domingo) ------------------------------------
     A CONFIRMAR: nem o Instagram nem o Linktree informam horário.
     Seg a Sáb, 10h às 19h, é só um ponto de partida para a demo.
  ------------------------------------------------------------------ */
  expediente: {
    0: { aberto: false },
  ...
  ------------------------------------------------------------------ */
  barbeirosDemo: [
    { id:'caio', slug:'caio', nome:'Caio Bastos', foto:'fotos/perfil.jpg', instagram:'caiobastostattoo', cargo:'Tatuador' }
  ],
  ...
  servicosDemo: [
    ...
    { id:'sessao-pequena', nome:'Sessão pequena',        descricao:'Fineline, flash de old school e peças pequenas.',                            preco_centavos:0, a_partir_de:false, duracao_min:120, categoria:'Sessões' },
    { id:'sessao-media',   nome:'Sessão média',          descricao:'Antebraço, panturrilha, coxa: blackwork, neotrad e ornamentais.',             preco_centavos:0, a_partir_de:false, duracao_min:240, categoria:'Sessões' },
    { id:'sessao-fechada', nome:'Sessão fechada',        descricao:'O dia inteiro reservado para back piece e fechamentos.',                      preco_centavos:0, a_partir_de:false, duracao_min:360, categoria:'Sessões' },
  ...
  /* ---- Estilos que aparecem no pedido --------------------------------
     Os destaques do Instagram (conferido em 23/09/2026).
  ------------------------------------------------------------------ */
  estilos: ['Colorida', 'Old school', 'Dotwork', 'Neotrad', 'Back piece', 'Fineline', 'Blackwork', 'Ornamental', 'Suminagashi', 'Ainda não sei']
};
